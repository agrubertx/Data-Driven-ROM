...
model_name=f'testNSEGCN2'   # for saving and loading

net = NetGCN2(10104, 32, 3, 8, 2, 4, data.edge_index[0])
print(net)

train_network(net, model_name, data, 32, 0.0005, stopNum=50, no_pde=True)
...
fig.suptitle('GCNN: Exact, Reconstructed, Error')
